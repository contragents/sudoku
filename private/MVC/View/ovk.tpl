  ...
  <div class="header__container" id="menu">
    ...
    <div class="header__contacts">
      ...
      <div class="header__contact">
        ...
        <a href="<?= $phone['href'] ?>" class="header__link text text_style_normal"><?= $phone['full'] ?></a>
      </div>
    </div>
	...
	<div class="welcome__container">
		<div class="welcome__block">
			<h1 class="welcome__title">Участвуем в размещении <span><?=$emitentFN?></span></h1>
			<ul class="welcome__list checked-list">
                <li class="welcome__item">Подача заявки на подготовку оферты на выкуп акций дополнительного размещения НПК «Объединенная Вагонная Компания»</li>
                <li class="welcome__item">Стоимость услуги "Консультации по участию в доп. размещении акций НПК&nbsp;ОВК&nbsp;ПАО" <strong><span style="white-space: nowrap">30 000 рублей</span></strong></li>
				<li class="welcome__item">Подготовка документов, консультации и сопровождение сделки</li>
                <li class="welcome__item"><strong>Крайний срок подачи документов передвинут на 17.11.2023!</strong></li>
			</ul>
            <button class="welcome__button button button_color_accent-dark" data-popup-toggle="submit-application">
                Отправить заявку
            </button>
		</div>
		<div style="max-width:700px;" class="welcome__block">

			<span style="display:none" class="welcome__subtitle text text_style_bold">Калькулятор</span>
			<div class="welcome__sub-block">
                <div style="max-width:400px; max-height: 800px; overflow-y: scroll; overflow-x: hidden;" class="mostly-customized-scrollbar"><?= $oferta ?></div>
				<div style="display:none" class="welcome__market-price">
				...
				<form style="display:none" action="" class="welcome__form" id="calculator">
...
<section style="display:none;" id="process" class="process">
      ...
      <div class="popup__content">
        ...
        <form action="" class="popup__form" id="request-call">
          ...
          <button class="popup__button button button_color_accent-dark">Заказать звонок</button>
            <span class="popup__warning">Нажимая кнопку Отправить заявку, Вы соглашаетесь с условиями Договора-Оферты</span>
        </form>
      </div>
    </div>
  </div>
...
<script src="js/app_ovk.js"></script>
</body>
