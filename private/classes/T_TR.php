...
class T_TR
{
    const PHRASES = [
        ...
        '<strong>File upload error!</strong><br /> Please review:<br /> <ul><li>file size (no more than <strong>' => '<strong>Dosya yükleme hatası!</strong><br /> Lütfen inceleyin:<br /> <ul><li>dosya boyutu (en fazla <strong>',
        ...
        'Period' => 'Dönem',
        'Word' => 'Kelime',
        'Points/letters' => 'Puanlar/harfler',
        'Result' => 'Sonuç',
